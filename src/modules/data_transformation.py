...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function will do data transformation for numerical
        ...
        try:
            ...
            logging.info(f"Numerical scaling is done...{numerical_features}")
            ...
            logging.info(f"Categorical encoding is done...{categorical_features}")
